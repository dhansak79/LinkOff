...
export const ACTIVITY_FEED_SELECTOR = '.scaffold-finite-scroll--infinite'
export const FEED_SELECTOR_CANDIDATES = [FEED_SELECTOR, FEED_SELECTOR_LEGACY, ACTIVITY_FEED_SELECTOR]
