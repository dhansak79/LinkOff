...
Defines the four swamp extension models that expose lint, knip, deno extension tests, and patch-coverage as trackable swamp model methods with stored results, enabling every pre-commit check to be recorded as swamp data.
